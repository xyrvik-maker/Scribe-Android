...
object DefaultThemes {
    ...
    val all: List<AppTheme> = listOf(
        ...
        AppTheme(
            ...
            colors = ThemeColors(
                background = "#0f0f12", surface = "#16161b",
                text = "#e7e5df", mutedText = "#8a8a8f", accent = "#7aa2f7",
                border = "#26262d", selection = "#3d4a73",
                toolbar = "#16161b", toolbarText = "#e7e5df"
            ),
        ...
        AppTheme(
            ...
            colors = ThemeColors(
                ...
                text = "#d4d4d4", mutedText = "#777777", accent = "#a8a8a8",
